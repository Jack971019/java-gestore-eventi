    ...
    public static void main(String[] args) {
        ...
        while (!datiValidi) {
            ...
            if (userChoice.equalsIgnoreCase("Y")) {
                ...
                System.out.println("posti disponibili: " + (numeroPostiTotale - numeroPostiPrenotati - evento.getNumeroPostiPrenotati()));
            ...
            if (userChoice1.equalsIgnoreCase("Y")) {
                try {
                    ...
                    System.out.println("posti disponibili: " + (evento.getNumeroPostiTotale() - numeroPostiPrenotati));
